import svgPaths from "./svg-rak94pqfl6";
...
export default function Inner() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[20px] items-center justify-center px-0 py-[20px] relative size-full" data-name="inner">
      <Tit />
      <Component1 />
      <Component2 />
      <Component3 />
