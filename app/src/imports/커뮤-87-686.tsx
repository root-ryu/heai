import svgPaths from "./svg-fqe1m3ekma";
...
function Frame59() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[20px] h-[499px] items-center px-0 py-[20px] relative shrink-0 w-full">
      <Frame77 />
      <Post1 />
      <Post2 />
      <Post3 />
...
function Inner() {
  return (
    <div className="bg-[#f8f8f8] content-stretch flex flex-col h-[2328px] items-center overflow-clip relative shrink-0 w-full" data-name="inner">
      <Frame59 />
      <Gnb />
      <HomeIndicator />
    </div>
...
function Btn() {
  return (
    <div className="absolute bg-[#5a54fa] content-stretch flex items-center justify-center left-[309px] overflow-clip rounded-[50px] size-[50px] top-[643px]" data-name="btn">
      <Edit1 />
    </div>
  );
}
...
export default function Component7() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-[20px] size-full" data-name="커뮤">
      <StatusBar />
      <Main />
      <Container />
      <Frame76 />
