...
const imgUndefinedChangeTheBorderTo2 =
...
const imgChatGptImage202511180346271 =
  '/1d07edb02029289dc0db532232a0a32be74b0ba7.png'; // Meditation
const imgImage1487 = '/d274f02ee1b28906991feeafdec500a2ca07fa69.png'; // Sleep
const imgD1Ab8437258E4F5D9609F294541080A31 =
  '/b083f23c756789098edb8ed36f219098ed33b8ca.png'; // Sleep Card
const imgChatGptImage202511180309341 =
  '/093df2697a767b1e891b0eaa5bc949cbbac3c388.png'; // Steps Character
const imgChatGptImage202511201120493 =
  '/027e8d9fbd9406238a5ebf69f9f621f04dc4dee3.png'; // Premium Banner
        ...
        `}</style>
            ...
            <div className="flex flex-col gap-[24px] items-center rounded-[10px] w-full max-w-[343px]">
              ...
              <div className="flex flex-col gap-[10px] items-start w-full">
                <div className="box-border flex items-center justify-between px-[2px] py-0 w-full">
                  ...
                  <div className="bg-[rgba(223,229,255,0.4)] h-[32px] overflow-clip relative rounded-[20px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.04)] w-[221px] shrink-0">
                    <div className="absolute flex gap-[8px] items-center left-[8.5px] top-[4px]">
                      <div className="flex items-center justify-center w-[53px]">
                        ...
                        <p
                          className="font-roboto font-medium leading-[22px] text-[#0c0c0c] text-[16px] text-center text-nowrap"
                      ...
                      <div className="relative w-[138px]">
                        ...
                        <p className="absolute font-pretendard font-medium leading-none left-[calc(50%-0.5px)] text-[12px] text-[rgba(12,12,12,0.2)] text-center text-nowrap top-[2px] translate-x-[-50%] leading-none mt-[1px]">
                          2 / 10
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-[rgba(223,229,255,0.4)] rounded-[20px] p-[6px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.04)] shrink-0">
                    <div className="bg-white border border-[#dfe5ff] rounded-[15px] flex items-center justify-center gap-[6px] px-[10px] h-[24px]">
                      <img
                        src={imgUndefinedChangeTheBorderTo2}
                        alt=""
                        className="w-[16px] h-[16px] object-cover"
                      />
                      <span className="font-pretendard font-normal text-[#0c0c0c] text-[14px] leading-none mt-[1px]">
                        7,777
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center w-full gap-[10px]">
                  <p
                    className="font-roboto font-medium leading-[20px] text-[#b4c1ea] text-[14px] text-center w-full"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    TODAY
                  </p>
                    ...
                    {(() => {
                      ...
                      return dates.map((date, idx) => {
                        ...
                        return (
                          ...
                          >
                            <p
                              className={`font-roboto text-center text-nowrap ${
                                isToday
            ...
            <div className="flex flex-col gap-[52px] items-center justify-center w-full max-w-[343px]">
              ...
              <div className="flex flex-col gap-[10px] items-center w-full">
                <p className="font-pretendard font-semibold leading-[26px] text-[#333333] text-[20px] w-full">
                  오늘의 루틴
                </p>
                      ...
                      <div className="box-border flex flex-col gap-[10px] items-start px-0 py-[4px] relative w-full">
                        ...
                        <div className="flex items-center justify-between w-full">
                          <div className="flex gap-[10px] items-center">
                            ...
                            <p className="font-pretendard font-regular leading-[24px] text-[#0c0c0c] text-[16px] text-center text-nowrap">
                              물 마시기
                            </p>
                          </div>
                          <RoutineButton
                              ...
                              <div className="flex-none rotate-[180deg] scale-y-[-100%]">
                                <div className="relative size-[30px]">
                                  <img
                                    alt=""
                                    className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
                                    src={imgChatGptImage202511180346271}
                                  />
                                </div>
                              </div>
                            </div>
              ...
              >
                <div className="absolute flex gap-[40px] items-center left-1/2 top-[2px] translate-x-[-50%]">
                  <div className="flex flex-col items-start">
                    <p className="font-pretendard font-semibold leading-[26px] text-[18px] text-white">
                      수면 기록
                    </p>
                    ...
                    <p
                      className="font-roboto font-bold leading-[0] text-[#3baa5c] text-[0px] text-nowrap"
                      style={{ fontVariationSettings: "'wdth' 100" }}
                    >
              ...
              >
                ...
                <div className="absolute left-[19px] top-[21px] flex flex-col items-start gap-[2px]">
                  {/* Title */}
                  <p className="font-pretendard font-semibold leading-none text-[#02010e] text-[18px] text-nowrap">
                    만보기
                  </p>
                  ...
                  <p className="font-inter font-medium leading-none text-[#447fb1] text-[0px] text-nowrap text-left mt-[2px]">
                    <span className="font-pretendard font-bold text-[32px]">
                      7,123
                    </span>
                    <span
                      className="font-roboto font-medium text-[14px] tracking-[-0.408px]"
                      style={{ fontVariationSettings: "'wdth' 100" }}
                    >
                      {' '}
                    </span>
              ...
              >
                ...
                <div className="absolute flex flex-col gap-[6px] items-start left-[152px] top-[30px] w-[223px] z-10">
                  ...
                  <p className="font-pretendard font-semibold leading-[24px] text-[14px] w-full text-[#6c69ba]">
