...
const img = '/29730ee16b412ecb815a5ea38fef192f75fe4874.png';
const img175583051339328B855EeBc38424CB725B7550489330E2 =
  '/6b226a363770f9043803e399e7053e80809c53f7.png';
const img1 = '/fd2aa84c99d09e0c96625e3e4daa9607bd9c69bf.png';
const imgImage92 = '/587ee515c750bd68bb461300b07b5c4f101bc28b.png';
    ...
    <div className="bg-neutral-50 flex flex-col items-center w-full h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden w-full pb-[120px]">
        ...
        <div className="relative w-full flex justify-center pt-[80px]">
          ...
          {/* Camera Button */}
          <button
            className="absolute bg-[#f0f0f0] rounded-[50px] shadow-[0px_0px_6px_0px_rgba(0,0,0,0.2),0px_0px_16px_0px_rgba(0,0,0,0.12),0px_0px_12px_0px_rgba(0,0,0,0.14)] w-[55px] h-[55px] flex items-center justify-center"
            style={{ top: '262px', left: 'calc(50% + 63.5px)' }}
          >
            <svg
        ...
        <div className="flex justify-center gap-[32px] mt-[50px] px-[36px]">
          ...
          >
            ...
            <p className="font-['Pretendard:SemiBold',sans-serif] text-[16px] text-black">
              캘린더
            </p>
          </button>
          ...
          <button className="bg-white rounded-[10px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.15)] w-[80px] h-[80px] flex flex-col items-center justify-center">
            <div className="w-[56px] h-[48px] mb-[2px]">
              <img
                ...
                src={img175583051339328B855EeBc38424CB725B7550489330E2}
              />
            </div>
            <p className="font-['Pretendard:SemiBold',sans-serif] text-[16px] text-black">
              뱃지
