...
const imgFrame2147237666 = '/11d727bab4cdf56f775ae857e3b37e12b4bddac2.png';
const imgFrame2147237667 = '/818c3a52a301b9f862275c8982128d6f5646ca24.png';
                    ...
                    <div className="box-border content-stretch flex flex-col gap-[12px] items-center justify-center px-[20px] py-[16px] relative w-full">
                      <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[320px]">
                        ...
                        <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                          ...
                          >
                            <p className="font-['Pretendard:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#333333] text-[12px] text-nowrap whitespace-pre">
                              {categoryDisplayName}{' '}
                            </p>
                          </div>
                          <BookmarkButton />
