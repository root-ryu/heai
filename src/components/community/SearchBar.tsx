...
export default function SearchBar({ value, onChange, placeholder = "키워드를 검색 하세요..." }: SearchBarProps) {
  return (
    <div className="bg-white box-border content-stretch flex items-center justify-between px-0 py-[10px] relative shrink-0 w-[343px]">
            ...
            <div className="basis-0 content-stretch flex gap-[7px] grow items-center min-h-px min-w-px relative shrink-0">
              <div className="relative shrink-0 size-[24px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                  <path d={svgPaths.p19568f00} stroke="#AAAAAA" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                  <path d="M21 21L16.65 16.65" stroke="#AAAAAA" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                </svg>
              </div>
              <input
                type="text"
