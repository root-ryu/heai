...
export default function CustomizePage() {
  const [selectedCategory, setSelectedCategory] = useState<'face' | 'fashion' | 'room' | 'badge'>('face');
                ...
                <div className="absolute aspect-[15.1026/15.1032] left-[88.35%] right-0 top-[calc(50%+1px)] translate-y-[-50%]">
                  <div className="absolute inset-[-6.25%]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
                      <path d={svgPaths.p15112600} stroke="#808080" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                    </svg>
                  </div>
                </div>
                ...
                <div className="absolute left-1/2 size-[23.993px] top-1/2 translate-x-[-50%] translate-y-[-50%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                    <g clipPath="url(#clip0_25_904)">
                      <path d={svgPaths.p1c772200} fill="#9ABAFF" stroke="#9ABAFF" strokeWidth="0.2" />
                      <path d={svgPaths.p1fd8c600} fill="#9ABAFF" stroke="#9ABAFF" strokeWidth="0.2" />
                      <path d={svgPaths.p348ff280} fill="#9ABAFF" stroke="#9ABAFF" strokeWidth="0.2" />
                      <path d={svgPaths.pdff7800} fill="#9ABAFF" stroke="#9ABAFF" strokeWidth="0.2" />
                      <path d={svgPaths.pcf24b00} fill="#9ABAFF" stroke="#9ABAFF" strokeWidth="0.2" />
                      <path d={svgPaths.pb8d3380} fill="#9ABAFF" stroke="#9ABAFF" strokeWidth="0.2" />
                      <path d={svgPaths.p37eb5d40} fill="#9ABAFF" stroke="#9ABAFF" strokeWidth="0.2" />
                    </g>
                    <defs>
          ...
          <div className="content-stretch flex gap-[40px] h-[345px] items-end justify-center w-full">
            ...
            <div className="h-[300px] relative shrink-0 w-[46px]">
              ...
              <button 
                ...
                className={`absolute h-[58px] left-[2px] top-[242px] w-[42px] ${selectedCategory === 'badge' ? 'opacity-100' : 'opacity-60'}`}
              >
              ...
              <button 
                ...
                className={`absolute h-[58px] left-[2px] top-[164px] w-[42px] ${selectedCategory === 'room' ? 'opacity-100' : 'opacity-60'}`}
              >
              ...
              <button 
                ...
                className={`absolute h-[58px] left-[2px] top-[83px] w-[42px] ${selectedCategory === 'fashion' ? 'opacity-100' : 'opacity-60'}`}
              >
              ...
              <button 
                ...
                className={`absolute h-[58px] left-0 top-0 w-[46px] ${selectedCategory === 'face' ? 'opacity-100' : 'opacity-60'}`}
              >
