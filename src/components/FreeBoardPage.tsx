...
const ALL_POSTS: Post[] = [
  ...
  },
  {
    ...
    categoryColor: 'bg-[rgba(255,82,65,0.67)]',
    categoryBgColor: 'rgba(255,139,128,0.67)',
    title: '아이돌 나온다는것만 보고 샀는데 너무 후회해 야나두 언어..근데 생각해보니까 ...',
    image: imgFrame2147237724,
    views: 1452,
    likes: 1,
    comments: 2,
  ...
  },
  {
    ...
    categoryColor: 'bg-[rgba(255,82,65,0.67)]',
    categoryBgColor: 'rgba(255,139,128,0.67)',
    title: '막시무스... 너.. 진짜 나쁜 녀석이다냥..어떻게 먹을 걸 생각하고 운동하지 않을 수가 있는냥...',
  ...
  },
  {
    ...
    categoryColor: 'bg-[rgba(255,82,65,0.67)]',
    categoryBgColor: 'rgba(255,139,128,0.67)',
    title: '아니야.. 오늘 다 했고 호 봤다고.. 넉커버스 같은게 나올줄 알았는데 그냥 사람이 ㅎㅎ',
...
export default function FreeBoardPage() {
  ...
  // 자유게시판 카테고리만 필터링
  const freeBoardPosts = ALL_POSTS.filter(post => post.category === '자유게시판');
